...
namespace MauticPlugin\MauticLassoBundle;
...
/**
 * Class MauticLassoBundle.
 */
class MauticLassoBundle extends PluginBundleBase
{
    ...
    private static function getMetadata(EntityManager $em)
    {
        ...
        foreach ($allMetadata as $meta) {
            if (false === strpos($meta->namespace, 'MauticPlugin\\MauticLassoBundle')) {
                continue;
            }
