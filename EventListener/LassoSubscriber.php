...
class LassoSubscriber implements EventSubscriberInterface
{
    /**
     * @var RouterInterface
     */
    ...
    public static function getSubscribedEvents()
    {
        return [
            ...
            'mautic.lasso_post_save'         => ['onLassoPostSave', 0],
            'mautic.lasso_delete'       => ['onLassoDelete', 0],
            'mautic.lasso_replacement' => ['onTokenReplacement', 0],
        ];
    }
    ...
    public function onTokenReplacement(MauticEvents\TokenReplacementEvent $event)
    {
        ...
        if ($content) {
            ...
            list($content, $trackables) = $this->trackableModel->parseContentForTrackables(
                ...
                $tokens,
                'lasso',
                $clickthrough['lasso_id']
            );

            $lasso = $this->lassoModel->getEntity($clickthrough['lasso_id']);
            ...
            foreach ($trackables as $token => $trackable) {
                $tokens[$token] = $this->trackableModel->generateTrackableUrl($trackable, $clickthrough, false, $lasso->getUtmTags());
            }
